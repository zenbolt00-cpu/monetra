...
export default function AdminPayoutPage() {
  ...
  const handleExport = () => {
    const headers = ["Date", "Vendor", "Description", "Reference", "Amount", "Status"];
    ...
    link.setAttribute("download", `payout_records_${new Date().toISOString().slice(0, 10)}.csv`);
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-[#1d1d1f] line-clamp-1">Vendor Payout</h1>
          <p className="text-[#86868b] mt-1">Listing all outgoing payments and debit records.</p>
        </div>
      ...
      <div className="glass p-1 rounded-2xl border-black/5 flex flex-wrap items-center gap-2">
        <div className="flex items-center gap-3 px-4 py-2 border-r border-black/5">
          ...
          <span className="text-[10px] uppercase font-bold tracking-widest text-[#86868b]">Filters</span>
        </div>
        <div className="ml-auto w-px h-6 bg-black/5 mx-2" />
        <div className="px-4">
          <p className="text-[10px] text-[#86868b] uppercase font-bold tracking-widest">Total Payout Volume</p>
